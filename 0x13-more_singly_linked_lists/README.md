...
OBOBOB==4369== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
julien@ubuntu:~/0x13. More singly linked lists$ 
Repo:
OBOBOB
GitHub repository: alx-low_level_programming
...
OBOBOBjulien@ubuntu:~/0x13. More singly linked lists$ ./h 
0
1
2
3
...
OBOBOB402
1024
OBOBOBjulien@ubuntu:~/0x13. More singly linked lists$ 
Repo:
...
OBOBOBjulien@ubuntu:~/0x13. More singly linked lists$ ./i 
sum = 1534
julien@ubuntu:~/0x13. More singly linked lists$ 
OBOBOBRepo:
...
int main(void)
{
    ...
    print_listint(head);
    printf("-----------------\n");
OBOBOB    delete_nodeint_at_index(&head, 5);
    print_listint(head);
    printf("-----------------\n");
OBOBOB    delete_nodeint_at_index(&head, 0);
    print_listint(head);
    printf("-----------------\n");
OBOBOB    delete_nodeint_at_index(&head, 0);
    print_listint(head);
